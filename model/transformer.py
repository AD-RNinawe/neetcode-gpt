...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.ln=self.VanillaNeuralNetwork(model_dim)
        self.fn=nn.LayerNorm(model_dim)
        self.sn=nn.LayerNorm(model_dim)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        embedded=embedded+self.attn(self.fn(embedded))
        embedded=embedded+self.ln(self.sn(embedded))
